...
export default class ImageBrowser extends React.Component {
  ...
  renderHeader = () => {
    ...
    let headerText = selectedCount + ' ภาพ';
    if (selectedCount === this.props.max) headerText = headerText + ' (จำกัด)';
    return (
      <View
        style={{
          flexDirection: 'row',
      ...
      >
        <View>
          <Button
            buttonStyle={styles.buttonTextExit}
            color='#000'
            title="ออก"
        ...
        <View>
          <Button
            buttonStyle={styles.buttonTextSelect}
            color='#E2792D'
            title="เลือก"
